...
fn main() -> std::io::Result<()> {
    ...
    for query in queries.iter() {
        ...
        if res.len() >= 200000 && res.len() <= 280000 {
            println!("{} {} {} {} {} {} {}", query.range.low.x, query.range.low.y, query.range.low.z, query.range.high.x, query.range.high.y, query.range.high.z, res.len());
        }
    }
